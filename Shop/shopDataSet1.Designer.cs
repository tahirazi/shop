...
namespace Shop.shopDataSet1TableAdapters {
    ...
    public partial class categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[category] WHERE (([category_name] = @Original_category_name))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[category] ([category_name]) VALUES (@category_name);\r\nSELECT c" +
                "ategory_name FROM category WHERE (category_name = @category_name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[category] SET [category_name] = @category_name WHERE (([category_na" +
                "me] = @Original_category_name));\r\nSELECT category_name FROM category WHERE (cate" +
                "gory_name = @category_name)";
